...
<body>
    ...
    <article>
        <address contenteditable style="font-weight: 300;font-size:15px">
            <p>Client:</p>
            <p>M(e).{{ $devi->clients->nom }} {{ $devi->clients->prenom }}</p>
            <p>
                {{ $devi->clients->adresse }}
            </p>
            <p>{{ $devi->clients->tel }}</p>
            <p>{{ $devi->clients->email }}</p>
        </address>
    ...
    <p>Date: <span contenteditable>{{ $devi->created_at->format('Y-m-d') }}</span> </p>
        ...
        <table class="inventory">
            ...
            <tbody>
                @foreach ($ligniedevis as $ligniedevi)
                    <tr>
                        <td><span contenteditable>@if ($ligniedevi->type == 0)
                            Produits
                        @else
                            Services
                        @endif</span></td>
                        ...
                        @endif</span></td>
                        <td><span contenteditable>{{ $ligniedevi->prix }} DT</span><span contenteditable>DT</span></td>
                        <td><span contenteditable>{{ $ligniedevi->prixT }} DT</span><span contenteditable>DT</span></td>
                        <td>
                                <span contenteditable>{{ $ligniedevi->tva }}%</span><span contenteditable>%</span>
                        </td>
                        <td>
                                <span contenteditable>{{ $ligniedevi->tht }} DT</span><span contenteditable>DT</span>
                        </td>
                        <td>
                                <span contenteditable>{{ $ligniedevi->ptttc }} DT</span><span contenteditable>DT</span>
                        </td>
        ...
        <table class="balance">
            <tr>
                ...
                <td><span contenteditable>{{ $devi->MTHT }}</span><span contenteditable> DT</span></td>
            </tr>

            <tr>
                <th><span contenteditable>Total TVA</span></th>
                <td><span contenteditable>{{ $devi->MT }}</span><span contenteditable> DT</span></td>
            </tr>

            <tr>
                <th><span contenteditable>Total</span></th>
                <td><span contenteditable>{{ $devi->MTTTC }}</span><span contenteditable> DT</span></td>
